...
vlog -vlog01compat -work work +incdir+D:/FPGA/divider6/rtl {D:/FPGA/divider6/rtl/divide6_2.v}

vlog -vlog01compat -work work +incdir+D:/FPGA/divider6/quartus_prj/../sim {D:/FPGA/divider6/quartus_prj/../sim/tb_divide6_2.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_divide6_2
