...
vlog -vlog01compat -work work +incdir+D:/FPGA/half_add2/rtl {D:/FPGA/half_add2/rtl/half_add.v}
vlog -vlog01compat -work work +incdir+D:/FPGA/full_add2/rtl {D:/FPGA/full_add2/rtl/full_add.v}

vlog -vlog01compat -work work +incdir+D:/FPGA/full_add2/quartus_prj/../sim {D:/FPGA/full_add2/quartus_prj/../sim/tb_full_add.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_full_add
