...
vlog -vlog01compat -work work +incdir+D:/FPGA/divide5/rtl {D:/FPGA/divide5/rtl/divide5_3.v}

vlog -vlog01compat -work work +incdir+D:/FPGA/divide5/quartus_prj/../sim {D:/FPGA/divide5/quartus_prj/../sim/tb_divide5_3.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_divide5_3
