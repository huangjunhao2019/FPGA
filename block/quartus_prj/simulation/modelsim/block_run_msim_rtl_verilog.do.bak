...
vlog -vlog01compat -work work +incdir+D:/FPGA/block/rtl {D:/FPGA/block/rtl/block.v}

vlog -vlog01compat -work work +incdir+D:/FPGA/block/quartus_prj/../sim {D:/FPGA/block/quartus_prj/../sim/tb_block.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_block
