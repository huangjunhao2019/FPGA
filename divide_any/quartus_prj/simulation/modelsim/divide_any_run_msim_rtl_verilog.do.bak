...
vlog -vlog01compat -work work +incdir+D:/FPGA/divide_any/rtl {D:/FPGA/divide_any/rtl/divide_any.v}

vlog -vlog01compat -work work +incdir+D:/FPGA/divide_any/quartus_prj/../sim {D:/FPGA/divide_any/quartus_prj/../sim/tb_divide_any.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_divide_any
