...
vlog -vlog01compat -work work +incdir+D:/FPGA/dec2_4/rtl {D:/FPGA/dec2_4/rtl/2_4.v}

vlog -vlog01compat -work work +incdir+D:/FPGA/dec2_4/quartus_prj/../sim {D:/FPGA/dec2_4/quartus_prj/../sim/tb_2_4.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_2_4
